...
We can see a variety of patterns in time series. To understand and or model a time series, it is often helpful to split a time series into several components, each of which represents an underlying pattern category; this process is called decomposition. These categories are:
